            ...
            <div class="settings-content">
              <div class="content-wrapper" :class="{
                ...
                <template v-else>
                  ...
                  <div v-if="currentSection === 'user-directory'" class="section">
                    <UserDirectory />
                  </div>
...
import UserDirectory from '@/views/system/UserDirectory.vue'
...
const navItems = computed(() => {
  ...
  const all: NavItem[] = [
    ...
    { key: 'user-directory', icon: 'usergroup', label: t('settings.userManagement') },
...
const navGroups = computed<NavGroup[]>(() => {
  ...
  return [
    ...
    },
    {
      ...
      items: pickItems(['user-directory', 'system-global', 'runtime-queues', 'platform-api-keys', 'system-audit-log']),
    },
    {
      key: 'platform',
...
const handleClose = () => {
  ...
  if (route.path === '/platform/settings') {
    ...
    if (sec === 'user-directory' || sec === 'system-global' || sec === 'runtime-queues' || sec === 'platform-api-keys' || sec === 'system-audit-log') {
