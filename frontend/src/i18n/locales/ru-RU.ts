export default {
  ...
  tenantMember: {
    ...
    teaching: {
      lead: 'Ответственный за пространство',
      student: 'Студент',
      legacyOwner: 'Прежний ответственный (ожидает решения)',
      unknown: 'Неизвестная связь',
      legacyWarning: 'Устаревшая роль — здесь нельзя изменить; дождитесь миграции или обратитесь к супер-администратору',
    },
    columns: {
      member: 'Имя и email',
      role: 'Отношение',
    ...
    permissions: {
      title: 'Отношения в пространстве',
      desc: 'В учебном пространстве только «ответственный» и «студент». Контролируется сервером; элементы UI лишь отображают правила.',
      iconHint: 'Наведите курсор, чтобы открыть описание отношений',
  ...
  userProfile: {
    ...
    platformIdentity: {
      ...
      description: 'Классификация платформенного уровня (метка идентификации пользователя). Не изменяется при переключении рабочего пространства и выражается отдельно от ролей Owner/Admin/Contributor/Viewer.',
      values: {
        superadmin: 'Супер-администратор (с возможностями учителя)',
        teacher: 'Учитель',
        student: 'Студент',
        unset: 'Роль не задана',
      },
    },
    changePassword: {
  ...
  notes: {
    ...
    imageQuotaExceeded: 'Хранилище изображений заполнено (100 МБ на пользователя) — удалите часть изображений',
    title: 'Мои заметки',
    newNote: 'Новая заметка',
    untitled: 'Без названия',
    loading: 'Загрузка…',
    empty: 'Заметок пока нет — создайте первую справа сверху',
    selectHint: 'Выберите заметку слева или создайте новую',
    edit: 'Редактировать',
    preview: 'Просмотр',
    save: 'Сохранить',
    saved: 'Сохранено',
    ...
    autoSaveRetry: 'Автосохранение не удалось — повторится при вводе',
    draft: 'Черновик',
    saveFailed: 'Не удалось сохранить',
  ...
  platform: {
    ...
    noteSuffix: ' и адаптирована под учебные и научные материалы Сычуаньского сельскохозяйственного университета.',
    loginFeature1: 'Реальные материалы',
    loginFeature2: 'Реальные кейсы',
    loginFeature3: 'Мультимодальные документы и ReAct',
    highlight: {
      ragDesc: 'Гибридный поиск · точный подбор',
      agentDesc: 'Многошаговые рассуждения · вызов инструментов',
      wikiDesc: 'Автоизвлечение · структурные связи',
    },
  ...
  system: {
    ...
    globalSettings: {
      ...
      teachers: {
        label: 'Учителя',
        description: 'Назначенные учителя могут создавать учебные рабочие пространства. Введите email справа и нажмите Enter для назначения; нажмите × на теге для снятия учителя.',
        placeholder: 'Введите email пользователя и нажмите Enter',
        loadFailed: 'Не удалось загрузить список учителей',
        saveSuccess: 'Список учителей обновлён',
        saveFailed: 'Не удалось обновить список учителей',
        systemAdmin: 'Системный администратор (наследует возможности учителя, нельзя отозвать)',
        systemAdminHint: 'Эти аккаунты — платформенные супер-администраторы. Они автоматически наследуют возможности учителя, не требуют назначения и не могут быть отозваны здесь.',
        identityLabel: 'Платформенная роль управляемых аккаунтов',
        confirm: {
          appoint: {
            body: 'Назначить {email} учителем? Пользователь сможет создавать учебные рабочие пространства.',
            confirmBtn: 'Назначить'
          },
          revoke: {
            body: 'Снять учителя с {email}? После снятия пользователь больше не сможет создавать учебные рабочие пространства.',
            confirmBtn: 'Снять'
          }
        }
      },
      ownershipAnomalies: {
        label: 'Аномалии владельца пространства',
        description: 'Пространства без владельца или с несколькими владельцами требуют явного назначения супер-администратором; система не выбирает автоматически.',
        refresh: 'Обновить список',
        runMigration: 'Запустить миграцию ролей',
        empty: 'Нет открытых аномалий',
        tenant: 'Пространство #{id}',
        ownerCount: 'Число владельцев: {count}',
        pickLead: 'Выберите участника с возможностями учителя',
        resolve: 'Назначить ответственного',
        loadFailed: 'Не удалось загрузить аномалии',
        migrationDone: 'Миграция завершена: понижено {downgraded}, аномалий {anomalies}',
        migrationFailed: 'Ошибка миграции',
        resolveSuccess: 'Ответственный назначен',
        resolveFailed: 'Не удалось назначить ответственного',
        kind: {
          zero_owner: 'Нет владельца',
          multi_owner: 'Несколько владельцев',
        },
      },
      reset: {
        label: 'Сбросить',
  ...
  auth: {
    ...
    forceChangePassword: {
      title: 'Смените первоначальный пароль',
      description: 'В целях безопасности перед продолжением необходимо задать новый пароль.',
      submit: 'Обновить пароль',
      success: 'Пароль обновлён. Войдите снова с новым паролем.'
    }
  },
