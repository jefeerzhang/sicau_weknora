export default {
  ...
  notes: {
    saveAnswer: 'Добавить в заметки',
    saveAsNew: 'Новая заметка',
    appendToCurrent: 'Добавить в «{title}»',
    savedToNotes: 'Сохранено в заметки',
  },
  platform: {
    subtitle: 'Поиск учебных и научных материалов для университетских курсов. Вход по приглашению, самостоятельная регистрация закрыта.',
    schoolName: 'Сычуаньский сельскохозяйственный университет',
    founded: '1906',
    mottoLabel: 'Девиз',
    motto: '追求真理 造福社会 自强不息',
    spirit: '爱国敬业 艰苦奋斗 团结拼搏 求实创新',
    campuses: 'Яань · Чэнду · Дуцзянъянь',
  ...
  auth: {
    ...
    firstTime: 'Ещё нет аккаунта?',
    registerSuccess: 'Регистрация завершена. Войдите в систему',
    registerFailed: 'Ошибка регистрации',
    subtitle: 'Войдите с существующей учетной записью.',
    registerSubtitle: 'Заполните данные, чтобы зарегистрироваться',
